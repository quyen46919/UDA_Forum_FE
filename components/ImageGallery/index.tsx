            ...
            {images.map((image, index) => {
              return (
                <Stack
                  ...
                  sx={{
                    backgroundImage: `url(${image})`,
                    width: { sm: '33%', lg: '160px' },
                    height: { sm: '250px', lg: '160px' },
                    borderRadius: '8px',
                    mb: 0,
                    backgroundSize: 'cover',
                    backgroundRepeat: 'no-repeat',
                  ...
                  return (
                    <Stack key={index}>
                      <Stack
                        ...
                        sx={{
                          backgroundImage: `url(${image})`,
                          width: { sm: '160px', lg: '160px' },
                          height: { sm: '160px', lg: '160px' },
                          borderRadius: '8px',
                          mb: 0,
                          overflow: 'hidden',
                          cursor: 'pointer',
